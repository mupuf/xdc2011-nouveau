...
\begin{frame}
	...
	\begin{block}{History: GL version support (NVC0)}
		\begin{itemize}
			...
			\item OpenGL 4.5 support in Mesa 13.0 (unofficial)
		\end{itemize}
	\end{block}
...
\begin{frame}{Quick overview of OpenCL}
	\begin{block}{History}
		\begin{itemize}
			...
			\item OpenCL 1.2: 2011 (SPIR-V 1.0 support through ext);
			\item OpenCL 2.0: 2013 (SPIR-V 1.0 support through ext);
			\item OpenCL 2.1: 2015 (core SPIR-V 1.0 support);
			\item OpenCL 2.2: 2017 (core SPIR-V $\leq 1.2$ support);
		\end{itemize}
	\end{block}
	\begin{block}{Support, per vendor}
		\begin{itemize}
			\item Intel: via Intel SDK: 2.1, via Beignet: 2.0;
			\item AMD: via ROCm: 1.2–2.0, via clover: 1.1, via
				APP SDK: 2.0;
			\item NVIDIA: 1.2–2.0.
		\end{itemize}
	\end{block}
...
\begin{frame}{Quick overview of SPIR-V}
	\begin{columns}
		\begin{column}{0.5\textwidth}
			\begin{block}{History}
				\begin{itemize}
					\item SPIR-V 1.0: 2015;
					\item SPIR-V 1.1: 2016;
					\item SPIR-V 1.2: 2017.
				\end{itemize}
		...
		\end{column}
		\begin{column}{0.5\textwidth}
			\lstinputlisting[caption=Small SPIR-V example,style=customspirv]{example.spvasm}
		\end{column}
	\end{columns}
