...
% http://cvsweb.xfree86.org/cvsweb/xc/programs/Xserver/hw/xfree86/vga256/drivers/nv/Attic/nv3driver.c.diff?r1=1.1.2.5&r2=1.1.2.6&hideattic=0&only_with_tag=xf-3_3_3
	...
	\begin{frame}
		\begin{block}{History: The open-source strickes back}
			\begin{itemize}
				\item 2005: Stephane Marcheusin decides to improve the pre-obfuscation version by adding 3D
				\begin{itemize}
	...
	\begin{frame}
		\begin{block}{History: The return of the jedi}
			``It's so hard to write a graphics driver than open-sourcing it
...
\section{The nouveau community}
	\subsection{Composition}
		...
		\begin{frame}
			\begin{block}{Maxim Levintsky (MaximLevintsky)}
				\begin{itemize}
					\item Student at the Technion University of Haifa (GMT+2)
					\item Major reverse engineering work on reducing power consumption
			...
			\begin{block}{Maarten Lankhorst (mlankhorst)}
				\begin{itemize}
					...
					\item Work on implementing more using the VPx engines
					\item New-comer
				\end{itemize}
			\end{block}
		\end{frame}
